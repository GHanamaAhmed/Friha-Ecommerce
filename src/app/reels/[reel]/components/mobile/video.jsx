			...
			<div className="w-full h-full relative overflow-hidden">
				...
				{tools === true && (
					<>
						...
						<div
							className={`w-full flex flex-col items-center absolute bg-primaryColor bottom-0 rounded-t-xl duration-500 transition-transform z-10 h-4/5 ${
						...
						>
							...
							<div className="w-11/12 gap-2 py-2 items-center flex justify-between">
								<div className="w-full p-0 m-0 relative bg-transparent">
									<textarea
										className="peer resize-none w-full h-10 rounded-md bg-transparent px-3 py-2 font-sans text-sm font-normal text-lightContent outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-cyan-600 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
										placeholder=" "
									/>
