    ...
    <>
      <div className="flex  h-full w-full flex-col items-center justify-around gap-3 sm:flex-row">
        ...
        <Card
          ...
          title={"إكمال الشراء"}
          subtitle={
            "عند الانتهاء من تحديد الكميات والخصائص، انتقل إلى صفحة المعلومات (checkout). هنا، ستُطلَب منك ملء معلومات الشحن الفاتورة اللازمة. تأكد من تقديم معلومات دقيقة لضمان وصول طلبك بنجاح."
          }
        />
      </div>
      <img
