    ...
    >
      ...
      <div className="flex w-11/12 items-center justify-between gap-2 py-2">
        <div className="relative m-0 w-full bg-transparent p-0">
          <textarea
            className="peer h-10 w-full resize-none rounded-md bg-transparent px-3 py-2 font-sans text-sm font-normal text-lightContent outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-scandaryColor focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            placeholder=" "
          />
